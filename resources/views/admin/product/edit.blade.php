        ...
        <div class="page-content page-container" id="page-content">
            <div class="padding">
                <div id="invoice-list" data-plugin="invoice">
                    <div class="col-md-8">
                        <form action="{{ url('admin/product/update', $part->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label for="merk" class="form-label">Merk</label>
                                <div class="input-group-append">
                                    <input type="text"  class="form-control" id="merk" name="merk" value="{{ $part->merk }}"
                            ...
                            <div class="form-group"><label>Select Brands</label><select id="select2-single"
                                    data-plugin="select2" class="form-control" name="brand_id">
                                        @foreach ($brands as $brand)
                                        @if($part->brand == $brand->id)
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group-append">
                                    <input type="number" min="0" max="{{ $part->qty }}" class="form-control" id="qty" name="qty" value="{{ $part->qty }}"
                                        aria-describedby="imageHelp">
                                    @error('qty')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group-append">
                                    ...
                                    <input type="text" class="form-control" id="weight" name="weight" value="{{ old('weight', $part->weight) }}"
                                        aria-describedby="imageHelp">
                                    @error('weight')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="details" rows="6" id="body"
                                    placeholder="Enter the Content" name="details">{!! $part->details !!}</textarea>
                                @error('details')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
